...
const REGION_COORDINATES = [
  { id: 'GeoJea', name: '거제시', x: 2620, y: 532 },
  { id: 'GeoChang', name: '거창군', x: 2490, y: 340 },
  { id: 'GoSung', name: '고성군', x: 2558, y: 500 },
  { id: 'KimHea', name: '김해시', x: 2658, y: 445 },
  { id: 'NamHea', name: '남해군', x: 2489, y: 548 },
  { id: 'MeelYang', name: '밀양시', x: 2645, y: 395 },
  { id: 'SaCheon', name: '사천시', x: 2505, y: 485 },
  { id: 'SanCheong', name: '산청군', x: 2490, y: 423 },
  { id: 'YangSan', name: '양산시', x: 2690, y: 415 },
  { id: 'EuiRyeong', name: '의령군', x: 2558, y: 413 },
  { id: 'JinJu', name: '진주시', x: 2530, y: 460 },
  { id: 'ChangNyeong', name: '창녕군', x: 2593, y: 390 },
  { id: 'ChangWon', name: '창원시', x: 2622, y: 450 },
  { id: 'TongYeong', name: '통영시', x: 2585, y: 520 },
  { id: 'HaDong', name: '하동군', x: 2472, y: 480 },
  { id: 'HamAn', name: '함안군', x: 2580, y: 440 },
  { id: 'HamYang', name: '함양군', x: 2460, y: 380 },
  { id: 'HapCheon', name: '합천군', x: 2530, y: 383 },
];
...
export default function Map({
  ...
  isActiveFestival: { festivalRegion: string }[];
  soonActiveFestival: { festivalRegion: string }[];
}) {
  ...
  function getRegionStyle(regionId: string) {
    ...
    // 축제 상태 확인
    const hasActiveFestival = isActiveFestival.some(
      (festival) => festival.festivalRegion === regionIndex.toString(),
    );
    const hasSoonActiveFestival = soonActiveFestival.some(
      (festival) => festival.festivalRegion === regionIndex.toString(),
    );
