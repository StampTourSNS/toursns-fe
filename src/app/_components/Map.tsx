      ...
      >
        ...
        <g>
          ...
          <text
            ...
            fontSize="12"
            fill="#333"
            filter="url(#region-label-bg-color) url(#region-label-shadow)"
          >
            {REGION_COORDINATES[0].name}
          </text>
          <path
            className={styles['sop-interactive']}
